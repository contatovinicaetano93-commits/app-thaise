...
import { Menu, X, LayoutDashboard, Building2, Truck, Users, Package, ShoppingCart, Code2, Layers, LogOut, Sparkles, GitBranch, Server, UserCheck, Bell } from 'lucide-react'
